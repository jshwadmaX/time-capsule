// Interactive Canvas Background (Same as other pages)
...
// Form Validation - Submit to Flask backend
function setupFormValidation() {
    ...
    if (form) {
        form.addEventListener('submit', (e) => {
            ...
            // Validation passed - allow form to submit to Flask
            // No preventDefault() here, form will submit naturally
        });
    }
}
